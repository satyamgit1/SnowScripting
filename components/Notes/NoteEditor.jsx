...
//               >
//                 {scriptSubTypes[formData.scriptType].map((subType) => (
//                   <option key={subType.value} value={subType.value} className="bg-gray-800">
//                     {subType.label}
//                   </option>
//                 ))}
//               </motion.select>
...
//               Pro Tip
//             </motion.span>
//             <p>Use <strong className="text-emerald-300">Ctrl+B</strong> to bold selected text or right-click for formatting options</p>
//           </motion.div>
//         </motion.div>
