      ...
      <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 min-h-screen">
        ...
        >
          ...
          >
            <Image
              ...
              width={192}
              height={192}
              className="w-48 h-48 mx-auto rounded-full border-4 border-emerald-500 shadow-2xl object-cover"
              priority
            />
          </motion.div>
          ...
          >
            <a 
              ...
              className="px-6 py-3 bg-emerald-500 text-white rounded-full shadow-lg hover:bg-emerald-600 transition-all flex items-center"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-6 py-3 bg-gray-800 text-white rounded-full shadow-lg hover:bg-gray-700 transition-all flex items-center"
            >
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Experience 1 */}
            <motion.div 
              className="bg-gray-800 p-8 rounded-xl shadow-lg border-l-4 border-emerald-500"
              variants={item}
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-100">ServiceNow Developer</h3>
                  <p className="text-gray-400">@Exterprise • Jan 2025 – Present</p>
                </div>
              </div>
            ...
            >
              <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-100">Full Stack Developer</h3>
        ...
        <section className="container mx-auto px-4 py-16 bg-gradient-to-br from-gray-900 to-gray-800">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-gray-100">Apartment Management System</h3>
                <p className="text-gray-400 mb-4">Next.js, Express, Node.js, MongoDB</p>
                <p className="text-gray-300 mb-6">A comprehensive solution for apartment management with features for residents and administrators.</p>
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-gray-100">Real Estate Platform</h3>
                <p className="text-gray-400 mb-4">Next.js, Tailwind CSS, Firebase</p>
                <p className="text-gray-300 mb-6">A modern real estate platform showcasing properties with filters, search functionality, and contact forms.</p>
                <div className="flex space-x-3">
                  <a 
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-3 text-gray-100">100 JavaScript Questions</h3>
                <p className="text-gray-400 mb-4">React, TypeScript, Next.js</p>
                <p className="text-gray-300 mb-6">Interactive quiz application featuring 100+ JavaScript questions to test and improve coding knowledge.</p>
                <div className="flex space-x-3">
                  <a 
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-100 mb-1">Bachelor of Engineering in Computer Science</h3>
                  <p className="text-lg text-gray-400 mb-3">Thakur College of Engineering (2020-2024)</p>
                  <p className="text-gray-300">Courses: Data Structures, Web Design, Cloud Computing, AI/ML</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-start">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-100 mb-1">Higher Secondary School</h3>
                  <p className="text-lg text-gray-400 mb-3">St. Anne's Junior College (2018-2020)</p>
                  <p className="text-gray-300">Computer Science . Began freelancing in software development.</p>
                </div>
              </div>
            </motion.div>
          ...
          <div className="container mx-auto text-center">
            ...
            >
              <a 
                ...
                className="inline-flex items-center px-8 py-4 bg-white text-emerald-600 rounded-full text-lg font-bold shadow-lg hover:bg-gray-100 transition-all"
              >
