...
//         {/* Desktop navigation */}
//         <nav className="hidden md:flex items-center space-x-8">
//           <button onClick={() => scrollToSection('features')} className="text-gray-300 hover:text-emerald-400 transition-colors font-medium">
//             Features
//           </button>
//           <button onClick={() => scrollToSection('testimonials')} className="text-gray-300 hover:text-emerald-400 transition-colors font-medium">
//             Testimonials
//           </button>
//           <Link href="/blog" className="text-gray-300 hover:text-emerald-400 transition-colors font-medium">
//             Blog
//           </Link>
//           <Link href="/contact" className="text-gray-300 hover:text-emerald-400 transition-colors font-medium">
//             Contact
//           </Link>
//         </nav>

//         <div className="hidden md:flex items-center space-x-4">
//           <Link href="/auth" className="px-4 py-2 text-gray-300 hover:text-emerald-400 transition-colors font-medium">
//             Sign In
//           </Link>
//           <Link href="/auth" className={`px-5 py-2.5 bg-gradient-to-r ${colors.primary} text-white rounded-lg font-medium hover:opacity-90 transition-all shadow-md hover:shadow-emerald-500/20 ${colors.primaryHover}`}>
//             Get Started
//           </Link>
//         </div>
...
//               <button 
//                 onClick={() => scrollToSection('features')} 
//                 className="block w-full text-left py-2 text-gray-300 hover:text-emerald-400 transition-colors font-medium"
//               >
//                 Features
//               </button>
//               <button 
...
//                 Testimonials
//               </button>
//               <Link href="/blog" className="block py-2 text-gray-300 hover:text-emerald-400 transition-colors font-medium">
//                 Blog
//               </Link>
//               <Link href="/contact" className="block py-2 text-gray-300 hover:text-emerald-400 transition-colors font-medium">
//                 Contact
//               </Link>
...
//                   Get Started
//                 </Link>
//                 <Link href="/auth" className="block w-full py-2.5 text-center text-emerald-400 rounded-lg font-medium hover:bg-gray-700 transition-all">
//                   Sign In
//                 </Link>
//               </div>
//             </div>
