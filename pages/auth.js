...
//         >
//           <FaServicestack className="text-3xl text-teal-600" />
//           <span className="text-2xl font-bold text-teal-600">NowScript</span>
//         </motion.div>
...
// import { FaServicestack } from 'react-icons/fa';
// import { motion } from 'framer-motion';
// import { FiHome, FiBook, FiMail, FiLogIn } from 'react-icons/fi'; // Add icons here
...
//         </motion.div>
//         <div className="hidden md:flex items-center space-x-8">
//           <Link href="/" className="flex items-center text-gray-700 hover:text-teal-600 transition-colors">
//             <FiHome className="mr-2" /> Home
//           </Link>
//           <Link href="/blog" className="flex items-center text-gray-700 hover:text-teal-600 transition-colors">
//             <FiBook className="mr-2" /> Blog
//           </Link>
//           <Link href="/contact" className="flex items-center text-gray-700 hover:text-teal-600 transition-colors">
//             <FiMail className="mr-2" /> Contact Us
//           </Link>
//         </div>
//         <div className="flex items-center space-x-4">
//           <Link href="/auth" className="flex items-center px-4 py-2 text-gray-700 hover:text-teal-600 transition-colors">
//             <FiLogIn className="mr-2" /> Sign In
//           </Link>
//           <Link 
//             href="/auth" 
//             className="px-6 py-2.5 bg-gradient-to-r from-teal-500 to-blue-600 text-white rounded-lg font-medium hover:opacity-90 transition-all shadow-md"
//           >
//             Get Started
//           </Link>
//         </div>
