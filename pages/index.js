...
//                   pauseOnHover={true}
//                 >
//                   <Card customClass="bg-white p-6 rounded-xl border border-orange-200 shadow-lg">
//                     <div className="h-full flex flex-col">
//                       <div className="flex items-center mb-4">
//                         <div className="p-3 rounded-lg bg-orange-100 text-orange-600 mr-4">
//                           <FiCode className="w-6 h-6" />
//                         </div>
//                         <h3 className="text-xl font-semibold">Script Organization</h3>
//                       </div>
//                       <p className="text-gray-600 mb-4">Easily categorize and find all your ServiceNow scripts in one place.</p>
//                       <div className="mt-auto bg-orange-50 p-3 rounded-lg border border-orange-200">
//                         <div className="flex items-center space-x-2 text-orange-600">
//                           <FiCheck className="w-4 h-4" />
//                           <span className="text-sm font-medium">Works with all script types</span>
//                         </div>
//                       </div>
//                     </div>
//                   </Card>
...
//                       </div>
//                       <p className="text-gray-600 mb-4">Your scripts are protected with bank-level encryption and access controls.</p>
//                       <div className="mt-auto bg-orange-50 p-3 rounded-lg border border-orange-200">
//                         <div className="flex items-center space-x-2 text-orange-600">
//                           <FiCheck className="w-4 h-4" />
...
//                         </div>
//                         <h3 className="text-xl font-semibold">Project Workspaces</h3>
//                       </div>
//                       <p className="text-gray-600 mb-4">Organize scripts by project, client, or instance with custom tags.</p>
//                       <div className="mt-auto bg-orange-50 p-3 rounded-lg border border-orange-200">
//                         <div className="flex items-center space-x-2 text-orange-600">
//                           <FiCheck className="w-4 h-4" />
...
import gsap from 'gsap';
import CardSwap, { Card } from './CardSwap';
import SplashCursor from './SplashCursor'; // Assuming you have a SplashCursor component
                  ...
                  <Card customClass="bg-white p-6 rounded-xl border border-orange-200 shadow-lg">
                    <div className="h-full flex flex-col">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-xl font-semibold">Client Script</h3>
                      </div>
...
{`function onChange(control, oldValue, newValue, isLoading) {
  ...
  // Get the form GlideRecord
  var gr = g_form.getReference('incident');
  
  if (gr) {
    // Set the short_description based on the caller's location
    g_form.setValue('short_description', 
      'Issue reported from ' + gr.location.getDisplayValue());
    
    // Show a UI message
    g_form.showFieldMsg('caller_id', 
      'Caller location: ' + gr.location.getDisplayValue(), 'info');
  }
}`}
                          </code>
                        </pre>
                      ...
                      <div className="mt-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                        <div className="flex items-center space-x-2 text-orange-600">
                          <FiCheck className="w-4 h-4" />
                          <span className="text-sm font-medium">Client-side scripting example</span>
                        </div>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card customClass="bg-white p-6 rounded-xl border border-orange-200 shadow-lg">
                    <div className="h-full flex flex-col">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-xl font-semibold">Business Rule</h3>
                      </div>
                      <div className="flex-grow overflow-auto">
                        <pre className="text-xs bg-gray-50 p-4 rounded-lg overflow-x-auto">
                          <code className="language-javascript">
{`(function executeRule(current, previous) {
  // Only run for new incidents or when priority changes
  if (current.operation() === 'insert' || 
      current.priority.changes()) {
    
    // Set response time based on priority
    var responseTime = new GlideDateTime();
    
    switch (current.priority + '') {
      case '1': // Critical
        responseTime.addHours(1);
        break;
      case '2': // High
        responseTime.addHours(4);
        break;
      case '3': // Moderate
        responseTime.addHours(8);
        break;
      default: // Low
        responseTime.addHours(24);
    }
    
    current.response_due = responseTime;
    
    // Log to system log
    gs.info('Set response time for INC' + current.number + 
      ' to ' + responseTime.getDisplayValue());
  }
})(current, previous);`}
                          </code>
                        </pre>
                      ...
                      <div className="mt-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                        <div className="flex items-center space-x-2 text-orange-600">
                          <FiCheck className="w-4 h-4" />
                          <span className="text-sm font-medium">Server-side automation example</span>
                        </div>
                      </div>
                    </div>
                  </Card>
                  ...
                  <Card customClass="bg-white p-6 rounded-xl border border-orange-200 shadow-lg">
                    <div className="h-full flex flex-col">
                      <div className="flex items-center mb-4">
                        ...
                        <h3 className="text-xl font-semibold">REST API Script</h3>
                      </div>
                      <div className="flex-grow overflow-auto">
                        <pre className="text-xs bg-gray-50 p-4 rounded-lg overflow-x-auto">
                          <code className="language-javascript">
{`// Scripted REST API - Get incidents by caller
(function process(/*RESTAPIRequest*/ request, /*RESTAPIResponse*/ response) {
  var queryParams = request.queryParams;
  var callerId = queryParams.caller_id;
  
  if (!callerId) {
    return response.setError('caller_id parameter is required');
  }
  ...
  while (incidentGr.next()) {
    incidents.push({
      ...
      priority: incidentGr.priority.getDisplayValue(),
      state: incidentGr.state.getDisplayValue(),
      created: incidentGr.sys_created_on.getDisplayValue()
    });
  }
  ...
  return {
    ...
    incidents: incidents
                      ...
                      <div className="mt-4 bg-orange-50 p-3 rounded-lg border border-orange-200">
                        <div className="flex items-center space-x-2 text-orange-600">
                          <FiCheck className="w-4 h-4" />
                          <span className="text-sm font-medium">Custom API endpoint example</span>
                        </div>
                      </div>
                    </div>
                  </Card>
