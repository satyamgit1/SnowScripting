            ...
            >
              ...
              >
                <div className="flex justify-between items-center p-4 border-b border-gray-800">
                  <h3 className="text-xl font-semibold text-gray-100">SnowScripting Demo</h3>
                  <button
                ...
                <div className="p-6 bg-gray-800">
                  <p className="text-gray-300">
                    Watch how SnowScripting can transform your ServiceNow development workflow.
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-gray-100 mb-4">
                Trusted by{" "}
                <span className={colors.primaryText}>ServiceNow</span> Developer & Experts.
              </h2>
