...
const teamMembers = [
  ...
  },
  {
    ...
    role: 'ServiceNow Developer',
    image: 'aditya.png',
    bio: 'ServiceNow development and administration, Microsoft Azure cloud solutions, and Java-based application development. With a strong background in building scalable, efficient, and secure enterprise applications',
    color: 'from-emerald-500 to-teal-600',
    accentColor: 'bg-teal-500',
    socials: {
      // twitter: '#',
